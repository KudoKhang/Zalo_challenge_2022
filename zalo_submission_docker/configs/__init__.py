...
def parse_args():
    ...
    parser.add_argument('--protocol', type=str, default="private", help='protocal')
    ...
    parser.add_argument('--step_size', type=int, default=100, help='how many epochs lr decays once')
